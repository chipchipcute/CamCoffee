...
public class AdapterDisplayPayment extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.txt_custompayment_GhiChu = (TextView) view.findViewById(R.id.TextViewGhiChu);
        ...
        viewHolder.txt_custompayment_GhiChu.setText(ChiTietDonDatDTO.getGhiChu()); // Hiển thị ghi chú ở đây
