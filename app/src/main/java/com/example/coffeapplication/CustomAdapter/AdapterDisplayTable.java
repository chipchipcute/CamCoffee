...
import com.example.coffeapplication.Activities.PaymentActivity;
...
public class AdapterDisplayTable extends BaseAdapter implements View.OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(kttinhtrang.equals("true")){
            viewHolder.imgBanAn.setImageResource(R.drawable.table_order);
        }else {
            viewHolder.imgBanAn.setImageResource(R.drawable.table_normal);
        }
