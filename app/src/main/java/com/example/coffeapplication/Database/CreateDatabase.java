    package com.example.coffeapplication.Database;
    ...
    public class CreateDatabase extends SQLiteOpenHelper {
        ...
        public static String TBL_MON_GHICHU = "GHICHU";    // này là cột mới
        ...
        public static String TBL_CHITIETDONDAT_GHICHU = "GHICHU";  // này là cột mới
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String tblCHITIETDONDAT = "CREATE TABLE " +TBL_CHITIETDONDAT+ " ( " +TBL_CHITIETDONDAT_MADONDAT+ " INTEGER, "
                    ...
                    +TBL_CHITIETDONDAT_GHICHU+ " TEXT, " + " PRIMARY KEY ( " +TBL_CHITIETDONDAT_MADONDAT+ "," +TBL_CHITIETDONDAT_MAMON+ "))";


            String sql = "CREATE TABLE LUONG(MALUONG INTEGER PRIMARY KEY AUTOINCREMENT, LUONGTHUONG INTEGER,LUONGPHAT INTEGER,SOGIO INTEGER,NGAYTHANG TEXT,MANV INTEGER REFERENCES NHANVIEN(MANV))";
