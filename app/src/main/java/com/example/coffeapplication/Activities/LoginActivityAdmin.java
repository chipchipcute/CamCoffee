...
public class LoginActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //thuộc tính view
        TXTL_login_TenDN = (TextInputLayout)findViewById(R.id.textInputLayout2_admin);
        TXTL_login_MatKhau = (TextInputLayout)findViewById(R.id.textInputLayout_admin);
        BTN_login_DangNhap = (Button)findViewById(R.id.sign_buttonIn_admin);
    ...
    public void backFromLogin(View view)
    {
        ...
        pairs[0] = new Pair<View, String>(findViewById(R.id.layoutLogin_admin),"transition_login_admin");

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(LoginActivityAdmin.this,pairs);
